...
from .models import Keuangan, Kelompok, Anggota, Agenda, Absensi, AksesMenu, PanitiaPelaksana, TugasUpacara, PanitiaUtama, PetugasUpacara, KoordinatorKelompok
...
admin.site.register(KoordinatorKelompok)
